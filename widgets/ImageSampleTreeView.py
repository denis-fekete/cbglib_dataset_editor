...
class ImageSampleTreeView(QtWidgets.QTreeView):
    ...
    def loadSamples(self, restoreVerticalPosition=False):
        """
        ...
        if(restoreVerticalPosition):
            QTimer.singleShot(0, lambda: self.verticalScrollBar().setValue(verticalPos))

        self.selectionModel().blockSignals(False)
        self.blockSignals(False)
        return incorrectLabels
            
    def checkImageSampleWarnings(self, imageSample: ImageSample, checkLabelBoxes: bool = True, checkImageLabelBoxes: bool = False):
        """
    ...
    def loadSamplesFull(self, restoreVerticalPosition=False):
        """
        ...
        for imageSample in self.imageSamples:
            ...
            item2 = QtGui.QStandardItem(imageSample.labelPath)
